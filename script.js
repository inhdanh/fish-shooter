window.addEventListener("load", function () {
    ...
    draw(context) {
      ...
      if (this.game.gameOver) {
        ...
        if (this.game.score >= this.game.winningScore) {
          ...
          message1 = "Game Over";
          message2 = "Press Enter to Try Again";
        }
  ...
  class Game {
    ...
    update(deltaTime) {
      ...
      // ammoTimer is used to count up to ammoInterval before adding ammo, and ammoInterval is used to set the interval between ammo additions
